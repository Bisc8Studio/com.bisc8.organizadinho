...
using UnityEditor;
using UnityEngine;
using UnityOrganizer.Editor.Drawing;
...
{
    private const string PackageRoot = "Packages/com.erased.unityorganizer";
    private const string EditorResourcesRoot = PackageRoot + "/Editor Default Resources";
    private const string UnityOrganizerResourcesRoot = EditorResourcesRoot + "/UnityOrganizer";
    private const float PopupWidth = 300f;

    public const string IconFolder = UnityOrganizerResourcesRoot + "/Icons";
    public const string FontFolder = UnityOrganizerResourcesRoot + "/Fonts";
    ...
    public override Vector2 GetWindowSize()
    {
        ...
        {
            h += ln * 9f;
            if (UnityOrganizerUserPreferences.ShowCustomColor || _hd.colorMode == UnityOrganizerColorMode.Custom)
                h += ln;
    ...
    public override void OnGUI(Rect rect)
    {
        ...
        var currentMode = _hd != null ? _hd.colorMode : UnityOrganizerColorMode.Pastel;
        var currentHue = _hd != null ? _hd.colorHue : ColorPaletteUtility.DefaultHue;
        var currentCustomColor = _hd != null ? _hd.customColor : ColorPaletteUtility.GetBaseColor(UnityOrganizerColorMode.Pastel, ColorPaletteUtility.DefaultHue);
    ...
    {
        var palette = ColorPaletteUtility.BuildPalette(_hd.colorMode, _hd.colorHue, _hd.customColor);
        EnsureFolderExists(UnityOrganizerResourcesRoot, "Fonts");
    ...
    public static void EnsureIconFolderExists() => EnsureFolderExists(UnityOrganizerResourcesRoot, "Icons");
    public static void EnsureFontFolderExists() => EnsureFolderExists(UnityOrganizerResourcesRoot, "Fonts");
    ...
    private static void EnsureFolderExists(string parent, string child)
    {
        ...
        EnsureFolderChainExists(UnityOrganizerResourcesRoot);
