...
{
    private const string ShortcutButtonClassName = "unity-organizer-project-shortcut-button";
    private const string ShortcutPlaceholderClassName = "unity-organizer-project-shortcut-placeholder";
