...
namespace UnityOrganizer.Runtime
{
...
public class HierarchyDesign : MonoBehaviour
{
    ...
    [HideInInspector] public UnityOrganizerColorMode colorMode = UnityOrganizerColorMode.Pastel;
    ...
    public void EnsureColorData()
    {
        ...
        if (!System.Enum.IsDefined(typeof(UnityOrganizerColorMode), colorMode))
            colorMode = UnityOrganizerColorMode.Pastel;
